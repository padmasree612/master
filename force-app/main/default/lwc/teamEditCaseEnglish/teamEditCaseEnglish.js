...
import { OMNIDEF } from './teamEditCaseEnglish_def.js';
import tmpl from './teamEditCaseEnglish.html';
import tmpl_nds from './teamEditCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamEditCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
