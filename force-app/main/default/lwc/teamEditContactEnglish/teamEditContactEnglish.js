...
import { OMNIDEF } from './teamEditContactEnglish_def.js';
import tmpl from './teamEditContactEnglish.html';
import tmpl_nds from './teamEditContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamEditContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
